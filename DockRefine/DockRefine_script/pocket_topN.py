...
fp = open(scriptdir +'/input_pocket/pocket_align.' + poc_size)
fpreader = fp.read()
fp.close()

fpmol2=open(rootdir +'/input_pocket/' + '/pocket_topN.mol2','w')
fptop_pocket = open(rootdir +'/input_pocket/pocket_topN.info','w')
